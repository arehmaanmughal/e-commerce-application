          ...
          <Row className="gy-3">
            <Col className="">
              <div className="sale-macbooks rounded-3 ps-3">
                ...
                <img className="img-macbook" src="public\images\image 3.png" alt="" />
              </div>
            </Col>
            <Col>
              <div className="sale-accesseries rounded-3  ps-3">
                ...
                <img className="img-accessery" src="public\images\image accesery.png" alt="" />
              </div>
            </Col>
          </Row>
          <Row className="">
            <Col>
              <div className="smart-watch rounded-3 d-flex align-items-center mt-3 ps-3">
                <img className="img-watch" src="public\images\Rectangle 24.png" alt="" />
